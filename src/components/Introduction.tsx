...
function Introduction() {
  return (
    <section className="flex items-center absolute top-0 h-screen w-screen ">
      <Image
      ...
      <div className="absolute top-0 left-0 w-screen h-screen bg-[radial-gradient(80%_50%_at_50%_0%,_#268CF530_0%,_#268CF500_100%)] -z-40" />
