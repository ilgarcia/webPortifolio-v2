...
function Navigation() {
  return (
    <m.div
      className="flex justify-center items-center absolute lg:static top-0 right-0 bottom-0 [width:min(70vw,300px)] lg:w-fit font-fira text-base lg:text-sm lg:space-x-7 space-y-5 lg:space-y-0 z-50"
      variants={variants}
    >
