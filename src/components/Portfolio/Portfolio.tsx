...
function Portfolio({ portfolio, options }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* <div ref={emblaRef} className="max-w-7xl w-full mx-auto overflow-hidden">
        <div className="flex touch-pan-y -ml-4">
          <div className="relative max-w-6xl mx-auto flex-[0_0_100%] min-w-0 pl-4 ">
          ...
          {portfolio?.map((project, id) => (
            <div
              key={id}
              className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:items-center px-2 md:px-8 relative"
            >
              <div
