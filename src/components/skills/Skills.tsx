...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <h2 className="absolute lg:left-1/2 top-4 lg:top-auto lg:bottom-0 font-fira font-medium text-7xl md:text-8xl tracking-tighter text-slate-800/90">
        Skills.
      </h2>
      ...
      <div className="sk:col-span-4 flex flex-wrap justify-center items-center gap-1 sm:gap-1.5 md:gap-4 px-4">
        {skills.map((skill) => (
          <div key={skill._id}>
            <Badges skill={skill} />
          </div>
